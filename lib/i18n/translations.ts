...
export const dictionaries = {
  [Language.FR]: {
    ...
    'testimonials.title': 'La Voix des Collectionneurs',
    'testimonials.subtitle': 'Reconnu par les amateurs d\'art du monde entier',
  ...
  [Language.EN]: {
    ...
    'testimonials.title': 'Collector\'s Voices',
    'testimonials.subtitle': 'Trusted by art lovers worldwide',
  ...
  [Language.DE]: {
    ...
    'testimonials.title': 'Stimmen der Sammler',
    'testimonials.subtitle': 'Weltweit von Kunstliebhabern geschätzt',
  ...
  [Language.PT]: {
    ...
    'testimonials.title': 'Vozes dos Colecionadores',
    'testimonials.subtitle': 'Confiado por amantes da arte em todo o mundo',

...
export const About: React.FC = () => {
  ...
  // Parallax movement for the entire image container (image + border)
  const yContainer = useTransform(scrollYProgress, [0, 1], ["-10%", "10%"]);
    ...
    <section ref={containerRef} className="relative py-32 bg-light dark:bg-[#1a1a1a] overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-20">
            ...
            {/* Image Side - Grouped Parallax */}
            <div className="w-full lg:w-1/2 relative flex justify-center lg:block">
                {/* 
                   Applying parallax to the wrapper that contains both the border and the image.
                   This ensures they move in sync relative to the text, solving the overlap issue.
                */}
                <motion.div 
                    style={{ y: yContainer }}
                ...
                >
                    ...
                    {/* Decorative Border - Aligned relative to this moving container */}
                    <div className="absolute top-4 -right-4 w-full h-full border border-accent/30 rounded-sm z-0" />

                    {/* Image Container */}
                    <div className="relative z-10 overflow-hidden rounded-sm shadow-2xl aspect-[3/4] bg-gray-200 dark:bg-gray-800">
                        <img 
                    ...
                    >
                        <p className="text-accent font-serif italic text-lg leading-tight">
                            {t('about.quote')}
                        </p>
                    </motion.div>
                </motion.div>
